...
begin
  ...
  begin
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:='This will attach the debugger of Woke Engine to the current process. If you close Woke Engine while the game is running, the game will close too. Are you sure you want to do this?'
    else
      mes:='This will attach the debugger of Woke Engine to the current process. Continue?';
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','Woke Engine Debugger',0);
