...
resourcestring
  ...
  rsTutorial1='Welcome to the Woke Engine Tutorial (v3.6)'+#13#10+
              ''+#13#10+
              'This tutorial will teach you the basics of cheating in video games. It will also show you foundational aspects of using Woke Engine (or WE for short). Follow the steps below to get started.'+#13#10+
              ''+#13#10+
              '1: Open Woke Engine if it currently isn''t running.'+#13#10+
              ...
              ''+#13#10+
              'Congratulations! If you did everything correctly, the process window should be gone with Woke Engine now attached to the tutorial (you will see the process name towards the top-center of WE).'+#13#10+
              ''+#13#10+
