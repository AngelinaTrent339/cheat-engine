...
resourcestring
  ...
  rsTutorialStep5=
      ...
      'When you''ve found the address, right-click the address in Woke Engine and choose "Find out what writes to this '+
      'address". A window will pop up with an empty list.'+#13#10+
      'Then click on the Change value button in this tutorial, and go back to Woke Engine. If everything went right, there '+
