...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'Woke Engine'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'Woke Engine'{$endif},true) then
      begin
        //I do have access
